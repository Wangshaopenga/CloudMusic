<template>
    <div class="footerBar">
                ...
                <div class="songDetails" v-if="songUrl">
                    ...
                    <div class="songInfo">
                        ...
                        <div class="disc">
                            ...
                            <div
                                class="needle"
                                :class="{ needle: true, crush: playState }">
                        ...
                        <div class="songDetails">
                            ...
                            <div class="title">
                                ...
                                <div
                                    class="collection"
                                    @click="
                                        toCollectionDetails(info.songInfo.al.id)
                                    ">
                    ...
                    <div class="songComments">
                        ...
                        <div
                            class="hotComments"
                            v-if="info.songComments.hotComments">
                            <!-- 标题 -->
                            <div
                                class="title"
                                v-if="info.songComments.hotComments.length">
                                热门评论
                            </div>
                            <!-- 详细 -->
                            <div
                                class="details"
                                v-for="(h, index) in info.songComments
                                    .hotComments"
                                :key="index">
                                <!-- 头像 -->
                                <div
                                    class="headerPhoto"
                                    @click="toUserDetails(h.user.userId)">
                        ...
                        <div
                            class="newComments"
                            v-if="info.songComments.comments">
                            <!-- 标题 -->
                            <div
                                class="title"
                                v-if="info.songComments.comments.length">
                                最新评论
                            </div>
                            <!-- 详细 -->
                            <div
                                ...
                                <div
                                    class="headerPhoto"
                                    @click="toUserDetails(c.user.userId)">
        ...
        <div class="footerBar_right">
            ...
            <div
                class="playlist"
                @click="info.playlistDrawer = !info.playlistDrawer">
                <i class="iconfont">
...
const changePlayState = (val) => {
    if (val) {
        if (songUrl) {
            ...
            if (info.songInfo.noCopyrightRcmd) {
                ElMessage({
                    message:
                        '歌曲可能没有版权,' +
                        info.songInfo.noCopyrightRcmd.typeDesc,
                    type: 'warning',
                    grouping: true,
                });
            } else {
...
const changeMusicDuration = (val) => {
    if (songUrl) {
        ...
        if (info.songInfo.noCopyrightRcmd) {
            ElMessage({
                message: info.songInfo.noCopyrightRcmd.typeDesc,
                type: 'warning',
                grouping: true,
            });
        } else {
